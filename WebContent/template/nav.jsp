	...
	<div class="top center">
		...
		<div class="right fr">
			...
			<div class="gouwuche fr">
				<a href="javascript:;" onclick="alert('请登陆')"
					style="display: block;">购物车</a>
			</div>
			<%
				} else {
			%>
			<div class="gouwuche fr">
				<a href="TrolleyServlet?action=listAll" style="display: block;">购物车</a>
			</div>
			<%
				}
			%>
			<div class="fr">
				<ul>
					...
					<li>|</li>
					<%
						if (operator.getRule() == 2) {
					%>
					<li></li>
					<li><a href="admin/index.jsp">管理后台</a></li>
					<li>|</li>
					<%
						}
					%>
